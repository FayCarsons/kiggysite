import { Image, getIconPath } from './Image';
...
export const Header = () => {
  ...
  return (
    <header class="mt-2 flex w-screen flex-col items-center justify-center">
      <Image
        className="mb-2 aspect-auto h-5/6 w-1/4 object-fill"
        title={getIconPath('logo')}
      />
      <Image
        className="mb-2 h-3/4 w-3/4 object-cover md:mb-4"
        title={getIconPath('title')}
      />
